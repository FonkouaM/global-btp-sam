                ...
                <h4>Nos services</h4>
                    ...
                    <Link className="link_to" to="/services">Entretien pour particuliers et petites entreprises</Link>
                        ...
                        <div className="contact">
                            ...
                            <p>Cameroun</p>
                            <br/>
                            <p><b>Phone:</b> <span>+237 6 86 43 93 94</span></p>
                            <p><b>Email: </b><Link to="https://formsubmit.co/globalbtp-sm@gmail.com">globalbtp-sm@gmail.com</Link></p>
                        <div className="footer__socials">
                            <Link className="link_to" to="https://wa.me/237686439394" target="_blank" rel="noreferrer noopener"><img src={Whatsapp} width='30' height='30' alt="source"/></Link>
                            <Link className="link_to" to="https://www.facebook.com/share/p/16bmfum2uo/" target="_blank" rel="noreferrer noopener"><img src={Facebook} width='30' height='30' alt="source"/></Link>
                            <Link className="link_to" to="#" target="_blank" rel="noreferrer noopener"><img src={Telegram} width='30' height='30' alt="source"/></Link>
                            <Link className="link_to" to="#" target="_blank" rel="noreferrer noopener"><img src={Snapchat} width='30' height='30' alt="source"/></Link>
                        </div>
                    </div>
                </div>
